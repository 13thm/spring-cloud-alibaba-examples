package com.thm.cloud.integration.gateway.config;
 ...
 * （对应 Nacos 中 integrated2-gateway.yaml 的 {@code Path=/praise/sentinel} 路由）。</p>
 *
 * @author thm
 */
@Configuration
public class GatewayConfig {
	 ...
	 * 本示例为简化演示，采用 @PostConstruct 启动时加载。</p>
	 */
	@PostConstruct
	public void initGatewayRules() {
		Set<GatewayFlowRule> rules = new HashSet<>();
		// 资源名 = 网关路由 ID；1 秒内最多 5 次，超出即限流
		rules.add(new GatewayFlowRule("praiseItemSentinel").setCount(5).setIntervalSec(1));
