package com.thm.cloud.integration.provider.controller;

import com.thm.cloud.integration.provider.message.PraiseMessage;
...
public class PraiseController {
	...
	/** 输出绑定名：对应 Nacos 配置 integrated2-provider.yaml 中 bindings.praise-output */
	 ...
	 * → StreamBridge 按绑定名 praise-output 发送到 topic PRAISE-TOPIC-02。
